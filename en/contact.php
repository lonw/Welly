<?php
   ...
   if (isset($_GET['hire'])) {
     $string= '<h2 style="color:grey;">&nbsp; Job Center</h2><br>';

     $leftside = ' <h3 id="hireme" class="bg-success"> JOB CENTER</h3>
     ...
     $string= '<h2 style="color:grey;">&nbsp;CONTACTS</h2><br>';

      $leftside = ' <h3 class="bg-success"> CONTACT INFO</h3>
                    <h4 style="text-decoration: underline;">WELLY INTERNATIONAL MEDIA LTD</h4>
